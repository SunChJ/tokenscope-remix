...
- **Live subscription quota** — Claude (5-hour + weekly) and Codex (weekly) refreshed every 60 seconds or on manual Refresh, shown Codex-status style (`29% left (resets 05:01 on 9 Aug)`), with a burn-rate projection
