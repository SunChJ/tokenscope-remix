...
- **Live subscription quota** — Claude (5-hour + weekly) and Codex (weekly + Spark 5-hour/weekly) refreshed every 60 seconds, shown Codex-status style (`29% left (resets 05:01 on 9 Aug)`), with a burn-rate projection
